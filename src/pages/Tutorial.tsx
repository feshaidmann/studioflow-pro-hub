...
const tabs = [
  ...
  { id: "visual", icon: Palette, label: "Direção Visual", short: "Visual" },
...
const tabContent: Record<TabId, React.ReactNode> = {
  "getting-started": (
    <div className="space-y-2">
      <SectionTitle>Bem-vindo ao StudioFlow Pro</SectionTitle>
      <p className="text-sm text-muted-foreground leading-relaxed">
        O StudioFlow Pro organiza todo o ciclo dos seus projetos musicais — da ideia até o lançamento.
    ...
    <div className="p-4 md:p-6 space-y-6 max-w-5xl mx-auto">
      <header className="animate-fade-in">
        ...
        <p className="text-muted-foreground mt-1">
          Aprenda a usar cada funcionalidade do StudioFlow Pro em poucos passos.
        </p>
      </header>
