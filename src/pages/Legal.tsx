...
Ao acessar e usar o StudioFlow Pro, você concorda com estes Termos de Uso. Se não concordar, não utilize a plataforma.

## 2. Descrição do Serviço
O StudioFlow Pro é uma plataforma de gestão para produtores musicais e artistas, oferecendo ferramentas de organização de projetos, controle financeiro, agenda e networking profissional.
...
Todo o conteúdo da plataforma (design, código, textos) é de propriedade do StudioFlow Pro. O conteúdo que você cria (projetos, dados) permanece seu.
