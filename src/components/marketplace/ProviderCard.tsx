...
export function ProviderCard({ provider, onRequestQuote }: Props) {
  ...
  return (
    <div className="rounded-[14px] border border-border bg-card p-4 flex flex-col gap-3 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-center justify-between gap-2 mt-auto">
        ...
        <Button size="sm" className="h-8 gap-1.5" onClick={() => onRequestQuote(provider)}>
