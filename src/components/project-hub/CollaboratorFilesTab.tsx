...
import { FolderOpen, Upload, Download, Trash2, FileText, Loader2 } from "lucide-react";
    ...
    <div className="space-y-4 py-2">
      ...
      <div className="space-y-2">
        {files.map((file) => {
          ...
          return (
            <div key={file.id} className="flex items-center gap-3 rounded-lg border border-border bg-card/60 p-3">
              ...
              <div className="flex items-center gap-1 shrink-0">
                <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => handleDownload(file.storage_path, file.original_name)}>
